...
<div className="absolute z-10 p-12 w-full sm:w-auto lg:w-auto">
   <nav className="footer-nav z-10 border-r border-white/20 pr-8 relative lg:top-[80px]">
     <ul className="lg:space-y-5 sm:space-y-2 mt-[10%] ">
  <li>
    <Link
      href="#lineup"
      className="cursor-pointer text-white sm:text-3xl md:text-5xl lg:text-6xl font-bold italic hover:text-white/80 transition-colors transform hover:scale-105"
    >
      LINEUP
    </Link>
  </li>
  ...
  width={1000}
  height={200}
  className='lg:max-w-[300%] sm:max-w-[120%] lg:w-[140%] sm:w-[80%] items-center justify-center mx-auto lg:ml-[78%] mt-[10%] transition-transform duration-300 ease-in-out hover:scale-105'
/>
    </div>
  </div>
